...
<section>
	...
	<c:choose> 
		...
		<div class="row left-gap">
			<input type="hidden" name="userid" id="userid" value="${user.userID}">
			 <div class="col-md-5">
			 	<div class="form-group">
					FirstName :<input type="text" name="firstname" maxlength="50" value="${requestScope.formdata.firstname}${user.firstname}" id="firstname" class="form-control" placeholder="Enter First Name">
				</div>
				<div class="form-group">
			...
			<div class="col-md-5">
				 <div class="form-group">
					Phone:<input type="text" name="phone" maxlength="10" value="${requestScope.formdata.phone}${user.phone}" size="10" id="phone" class="form-control" placeholder="Enter Phone Number" required>
				</div>
				 <div class="form-group">
				 	Date of Birth: <input type="date" id="birthday" class="form-control" value="${requestScope.formdata.dateofbirth}${user.dateofbirth}" name="birthdate" required>
				 </div>
				 <c:if test="${user==null}">
				  <div class="form-group">
				 	Gender:
			 		...
			 		<fieldset>
    					<legend>Security Questions:</legend>
			    			1.Who was your childhood super hero?<br>
			    				 <input type="text"  class="form-control" value="${requestScope.formdata.answer1}" maxlength="60" name="q1" required><br>
			    			2.What was your childhood nickname?<br>
			    				 <input type="text" class="form-control" value="${requestScope.formdata.answer2}" maxlength="60" name="q2" required><br>
    				</fieldset>
    			 </div>
    		 </div>
    	 </div>
